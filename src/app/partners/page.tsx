            ...
            {TRACKS.map((t, i) => (
              ...
              >
                <div>
                  ...
                  <h2 className="mt-3 font-display text-2xl font-bold leading-tight text-rhino-700 md:text-3xl">
                    {t.title}
                  </h2>
                </div>
                <div className="md:col-span-2">
                  ...
                  <Link
                    href="/contact"
                    className="mt-6 inline-flex items-center text-sm font-semibold text-denim-600 hover:text-denim-700"
                  >
                    {t.cta} →
                  </Link>
                </div>
