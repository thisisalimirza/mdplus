...
export default function Home() {
  return (
    <>
      ...
      {/* ── Social proof bar ─────────────────────────────────── */}
      <section className="border-y border-neutral-100 bg-neutral-0 py-10">
        <div className="mx-auto max-w-(--container-max) px-6">
          <p className="text-center text-xs font-semibold uppercase tracking-widest text-neutral-500">
            2,500+ members from top medical schools, residencies, and firms
          </p>
          <div className="mt-6 grid grid-cols-2 gap-x-8 gap-y-4 text-center text-sm font-medium text-neutral-400 sm:grid-cols-4 md:grid-cols-7">
            {[
              "Harvard",
              "Stanford",
              "Johns Hopkins",
          ...
          <p className="mt-4 text-center text-xs text-neutral-400">
            Logo strip placeholder — final logos to be sourced from member
        ...
        <div className="mx-auto max-w-(--container-max) px-6">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {PILLARS.map((pillar) => (
              ...
              >
                <h3 className="font-display text-2xl font-bold text-rhino-700">
                  {pillar.title}
                </h3>
                ...
                <Link
                  ...
                  {...("external" in pillar && pillar.external
                    ...
                    : {})}
                  className="mt-6 inline-flex items-center gap-1 text-sm font-semibold text-denim-600 transition-colors group-hover:gap-2 hover:text-denim-700"
                >
                  {pillar.cta}
                </Link>
              </article>
